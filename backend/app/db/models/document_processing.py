...
class DocumentClass:
    # Statutory & Identity Certificates
    GST_CERTIFICATE = "GST_CERTIFICATE"
    PAN_CERTIFICATE = "PAN_CERTIFICATE"
    PAN = "PAN"  # Backward compatibility alias
    UDYAM_CERTIFICATE = "UDYAM_CERTIFICATE"
    INCORPORATION_CERTIFICATE = "INCORPORATION_CERTIFICATE"
    DPIIT_STARTUP_CERTIFICATE = "DPIIT_STARTUP_CERTIFICATE"
...
class DocumentProcessing(Base, TimestampMixin):
    ...
    classification_evidence: Mapped[Optional[str]] = mapped_column(
        Text,
        nullable=True,
    )
    classification_page_number: Mapped[Optional[int]] = mapped_column(
        Integer,
        nullable=True,
    )
