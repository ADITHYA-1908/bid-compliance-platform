...
class AuditEventType:
    ...
    # Organization Identity & Duplicate Entity Detection
    ORGANIZATION_IDENTITY_CHECKED = "ORGANIZATION_IDENTITY_CHECKED"
    ORGANIZATION_DUPLICATE_DETECTED = "ORGANIZATION_DUPLICATE_DETECTED"
    ORGANIZATION_DUPLICATE_RESOLVED = "ORGANIZATION_DUPLICATE_RESOLVED"

    # Tender Commercial Evaluation & Method Configuration
    COMMERCIAL_EVALUATION_STARTED = "COMMERCIAL_EVALUATION_STARTED"
    COMMERCIAL_RANKING_GENERATED = "COMMERCIAL_RANKING_GENERATED"
    EVALUATION_METHOD_UPDATED = "EVALUATION_METHOD_UPDATED"
    COMMERCIAL_EVALUATION_RECALCULATED = "COMMERCIAL_EVALUATION_RECALCULATED"
...
class AuditEntityType:
    ...
    ORGANIZATION_IDENTITY_ASSESSMENT = "ORGANIZATION_IDENTITY_ASSESSMENT"
    ORGANIZATION_DUPLICATE_MATCH = "ORGANIZATION_DUPLICATE_MATCH"
