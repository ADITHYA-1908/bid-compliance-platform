...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-900 text-slate-100 selection:bg-purple-600 selection:text-white">
      {/* Top Navigation Bar */}
      <header className="navbar-gradient-border border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-tr from-purple-700 to-indigo-600 shadow-md glow-purple">
          ...
          <nav className="flex items-center gap-2 sm:gap-3">
            {loading ? (
              ...
              <Link
                href={portalRoute}
                className="inline-flex items-center gap-1.5 rounded-lg btn-shimmer px-4 py-2 text-xs font-semibold text-white shadow-sm transition-all"
              >
              ...
              <>
                <Link
                  href="/login"
                  className="rounded-lg px-3 py-1.5 text-xs font-semibold text-slate-300 hover:text-white hover:bg-slate-800/70 transition-colors"
                >
                  Sign In
                </Link>
                <Link
                  href="/signup"
                  className="inline-flex items-center justify-center rounded-lg btn-shimmer px-3.5 py-1.5 text-xs font-semibold text-white shadow-sm transition-all"
                >
                  Get Started
                </Link>
              </>
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden pt-12 pb-16 sm:pt-16 sm:pb-20">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full border border-purple-500/30 bg-purple-950/60 px-3.5 py-1.5 text-xs font-medium text-purple-300 shadow-sm backdrop-blur-md">
            ...
            <div className="space-y-3 max-w-4xl mx-auto">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white leading-tight">
                AI-Powered Integrated <span className="gradient-text-purple">Bid Compliance</span> Verification
              </h1>
            ...
            <div className="pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 text-left max-w-4xl mx-auto">
                ...
                <div className="group role-card-3d glass-card rounded-2xl border border-blue-800/30 p-6 hover:border-blue-500/60 flex flex-col justify-between shadow-xl hover:shadow-blue-900/20 transition-all duration-300">
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-tr from-blue-700 to-blue-500 text-white shadow-lg glow-indigo group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="group role-card-3d glass-card rounded-2xl border border-emerald-800/30 p-6 hover:border-emerald-500/60 flex flex-col justify-between shadow-xl hover:shadow-emerald-900/20 transition-all duration-300">
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-tr from-emerald-700 to-teal-500 text-white shadow-lg glow-emerald group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="group role-card-3d glass-card rounded-2xl border border-purple-800/30 p-6 hover:border-purple-500/60 flex flex-col justify-between shadow-xl hover:shadow-purple-900/20 transition-all duration-300">
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-tr from-purple-700 to-indigo-600 text-white shadow-lg glow-purple group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-800/60 flex items-center gap-2">
                    <Link
                      href="/login/admin"
                      className="flex-1 text-center rounded-xl btn-shimmer px-3 py-2.5 text-xs font-bold text-white shadow-md transition-all"
                    >
                      Admin Login
                    </Link>
                    <Link
            ...
            <div className="pt-8 flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-xs text-slate-400">
              <div className="flex items-center gap-2 bg-emerald-950/40 border border-emerald-800/30 rounded-full px-3.5 py-1.5 shadow-sm">
                <CheckCircle2 className="h-3.5 w-3.5 text-emerald-400" />
                <span className="text-emerald-300 font-medium">Automated Statutory Verification</span>
              </div>
              <div className="flex items-center gap-2 bg-blue-950/40 border border-blue-800/30 rounded-full px-3.5 py-1.5 shadow-sm">
                <CheckCircle2 className="h-3.5 w-3.5 text-blue-400" />
                <span className="text-blue-300 font-medium">Dynamic Eligibility Criteria</span>
              </div>
              <div className="flex items-center gap-2 bg-purple-950/40 border border-purple-800/30 rounded-full px-3.5 py-1.5 shadow-sm">
        ...
        <section className="stats-strip py-8">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div className="space-y-1">
                <p className="stat-number text-2xl sm:text-3xl font-extrabold">12,480+</p>
                <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Tenders Verified</p>
              </div>
              <div className="space-y-1">
                <p className="stat-number text-2xl sm:text-3xl font-extrabold">94,200+</p>
                <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Compliance Audits</p>
              </div>
              <div className="space-y-1">
                <p className="stat-number text-2xl sm:text-3xl font-extrabold">3,150+</p>
                <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Active Bidders</p>
              </div>
              <div className="space-y-1">
                <p className="stat-number text-2xl sm:text-3xl font-extrabold">&lt; 30 sec</p>
                <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Avg. Verification Time</p>
              </div>
            </div>
          </div>
        </section>
