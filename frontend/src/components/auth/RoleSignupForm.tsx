    ...
    <div className="flex min-h-screen flex-col justify-center px-4 py-12 sm:px-6 lg:px-8 bg-[#F5F8F7] text-slate-900 relative overflow-hidden font-body selection:bg-emerald-500 selection:text-white">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-lg text-center relative z-10">
        ...
        <div className="flex justify-center">
          <span className="inline-flex items-center gap-1.5 rounded-full px-3.5 py-1 text-xs font-bold uppercase tracking-wider bg-emerald-50 text-emerald-800 border border-emerald-200 shadow-2xs">
      ...
      <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-lg relative z-10">
        ...
        {showRoleTabs && !forcedRole && (
          <div className="mb-5 grid grid-cols-3 gap-1.5 rounded-2xl bg-white border border-slate-200 p-1.5 text-xs font-semibold shadow-2xs">
            <button
              type="button"
              ...
              className={`flex items-center justify-center gap-1.5 rounded-xl py-2.5 transition-all cursor-pointer ${
                activeRole === "BIDDER"
                  ? "btn-emerald-fintech font-bold text-white shadow-2xs"
