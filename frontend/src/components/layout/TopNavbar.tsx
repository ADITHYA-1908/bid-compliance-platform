            ...
            >
              <div className="border-b border-slate-100 px-4 py-2.5">
                ...
                <div className="mt-1.5">
                  <span className="inline-flex items-center rounded-full bg-emerald-50 border border-emerald-200 px-2.5 py-0.5 text-[10px] font-bold text-emerald-800 shadow-2xs">
              ...
              <div className="border-t border-slate-100 pt-1">
                <button
                  ...
                  className="flex w-full items-center gap-2.5 px-4 py-2 text-xs font-semibold text-red-600 hover:bg-red-50 hover:text-red-700 cursor-pointer transition-colors"
                  role="menuitem"
                >
