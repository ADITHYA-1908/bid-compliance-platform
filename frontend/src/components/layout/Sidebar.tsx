  ...
  return (
    <aside className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0 z-30 border-r border-slate-200 bg-white">
      ...
      <div className="border-t border-slate-200 p-3 bg-slate-50/50">
        <div className="mb-2.5 rounded-lg p-2.5 border border-slate-200 bg-white">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100 hover:text-slate-900 transition-colors cursor-pointer"
        >
