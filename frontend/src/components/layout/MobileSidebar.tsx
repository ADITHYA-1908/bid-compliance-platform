        ...
        <div className="relative mr-16 flex w-full max-w-xs flex-1 flex-col bg-white border-r border-slate-200">
          ...
          <div className="border-t border-slate-200 p-3 bg-slate-50">
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100 hover:text-slate-900 cursor-pointer shadow-2xs"
            >
